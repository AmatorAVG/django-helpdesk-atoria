...
HELPDESK_ALLOW_NON_STAFF_TICKET_UPDATE = env.bool('HELPDESK_ALLOW_NON_STAFF_TICKET_UPDATE', False)
HELPDESK_CREATE_TICKET_HIDE_ASSIGNED_TO = env.bool('HELPDESK_CREATE_TICKET_HIDE_ASSIGNED_TO', True)
HELPDESK_ENABLE_PER_QUEUE_STAFF_PERMISSION = env.bool('HELPDESK_ENABLE_PER_QUEUE_STAFF_PERMISSION', True)
HELPDESK_SHOW_EDIT_BUTTON_FOLLOW_UP = env.bool('HELPDESK_SHOW_EDIT_BUTTON_FOLLOW_UP', False)
